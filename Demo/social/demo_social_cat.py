...
parser.add_option('--F', dest = "F", default = 20, type = 'float', action="store", help="F")
parser.add_option('--FWall', dest = "FWall", default = 20, type = 'float', action="store", help="FWall")
parser.add_option('--lambda', dest = "lam", default = 20, type = 'float', action="store", help="lambda")
parser.add_option('--tau', dest = "tau", default = 20, type = 'float', action="store", help="tau")
